      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 sm:mb-14 animate-fade-in max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            Slide to your average deal size and see what a month of consistent outreach could realistically deliver.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto rounded-2xl bg-background/60 border border-border/50 p-6 sm:p-10 animate-fade-in">
          ...
          <div className="mb-8 max-w-xl mx-auto">
            <div className="flex justify-between items-center mb-1">
              <div className="flex items-center gap-2">
                ...
                <label className="text-sm sm:text-base font-semibold">Average Deal Size</label>
              </div>
              <span className="text-xl sm:text-2xl font-bold text-primary">{formatCurrency(clientValue)}</span>
            </div>
            <p className="text-xs text-muted-foreground mb-4">(What you typically charge per client or contract)</p>
            <Slider
              value={[clientValue]}
          ...
          <div className="space-y-2 mb-8 text-sm">
            ...
            <div className="flex justify-between items-center p-3 rounded-lg bg-muted/30">
              <span className="text-muted-foreground">Lead-to-Close Rate</span>
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="p-5 rounded-xl bg-primary/5 border border-primary/20">
              ...
              <p className="text-xs text-muted-foreground mt-1">Replies per Month</p>
            </div>
            <div className="p-5 rounded-xl bg-primary/5 border border-primary/20">
        ...
        <p className="text-center text-xs text-muted-foreground mt-8 max-w-2xl mx-auto">
          These are estimates based on industry averages. Your actual results will depend on your market, offer, and how well your sales team converts.
        </p>
